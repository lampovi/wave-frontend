...
class ContentController {
    constructor() {
        ...
        this.lyrics = document.querySelector(".lyrics__text");
    ...
    async setTrack(title, artist) {
        ...
        this.trackAnchor.href = "https://www.google.com/search?q=" + query;
...
class MusicController extends HTMLAudioElement {
    ...
    async connectedCallback() {
        ...
        this.onpause = (event) => {
            // if (window.chrome && this.state == "playing") super.play();
        }
    }
...
document.addEventListener("DOMContentLoaded", async (event) => {
    let api = new APIManager("wss://wave.lampovi.site/api/ws", "https://wave.lampovi.site/streams");
